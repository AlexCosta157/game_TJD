...
public class BattleSystem : MonoBehaviour
{
    ...
    IEnumerator SetupBattle() // co-rotine, sao uma especie de funcao que correm separadamente de todas as outras e podem ser passadas � frente sempre que quisermos
    {
